...
public class DoctorMapperTest {
    ...
    void mapModelToEntity() {
        Doctor doctor = new Doctor(1L,
                ...
                "doc@gmail.com",
                1,
                Map.of(1L, new Appointment(1L, LocalDate.now(), AppointmentState.OPEN, null, null, null),
                        2L, new Appointment(2L, LocalDate.now(), AppointmentState.CLOSED, null, null, null)));
